"""Qdrant RAG provider for promptfoo evaluation.
...
logger = get_logger("providers.qdrant_rag")


class QdrantRAGProvider(BaseProvider):
    """Full RAG provider using Qdrant for retrieval."""

    def __init__(self, config: dict | None = None):
        """Initialize Qdrant RAG provider.
